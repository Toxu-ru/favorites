...
var extraDropItems = [];
export function addExtraDropItem(item) {
  extraDropItems.push(item);
}

var selectedDropItemCallbacks = [];
export function selectedDropItem(cb) {
  selectedDropItemCallbacks.push(cb);
}
...
export default Ember.Component.extend({
  ...
  extraDropItems,
  selectedDropItemCallbacks,

  @computed('selectedDropItemCallbacks', 'extraDropItems')
  selectedDropItem(callbacks, extraDropItems) {
    let selected = null;

    callbacks.forEach(function(cb) {
      selected = cb.call(this, extraDropItems);
